...
type Order struct {
	...
	Time       int64  `protobuf:"varint,4,opt,name=created_on,json=Time" json:"created_on,omitempty"`
	Tablename  string `protobuf:"bytes,5,opt,name=restaurant_id,json=Tablename" json:"restaurant_id,omitempty"`
}
...
func (m *Order) GetTablename() string {
	if m != nil {
		return m.Tablename
	}
	return ""
...
type Order_OrderItem struct {
	...
	UnitPrice int64  `protobuf:"fixed32,3,opt,name=unit_price,json=unitPrice" json:"unit_price,omitempty"`
...
func (m *Order_OrderItem) GetUnitPrice() int64 {
	if m != nil {
		return m.UnitPrice
	}
	return 0
